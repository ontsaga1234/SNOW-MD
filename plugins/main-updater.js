...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/jon-snow-tech-bot/SNOW-MD/commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("*✅ ʏᴏᴜʀ snow-md ɪs ᴀʟʀᴇᴀᴅʏ ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ !*");
        }

        await reply("*🚀 ᴜᴘᴅᴀᴛɪɴɢ snow-md ʙᴏᴛ...*");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/jon-snow-tech-bot/SNOW-MD/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "SNOW-MD-main");
